...
exports.editNumber = void 0;
const addThousandsSeparator_1 = require("./addThousandsSeparator");
/**
 * arrangeNumber
 ...
 */
const editNumber = (value, limit, comma = false, mark = '+') => {
     ...
     */
    const valueString = value > limit ? limit + mark : value.toString();
    // カンマオプションがあった場合は、数字部に3桁区切りを加える。
    return comma ? addThousandsSeparator_1.addThousandsSeparator(valueString) : valueString;
};
exports.editNumber = editNumber;
