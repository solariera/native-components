 ...
 */
export declare type FrameStyleType = Omit<FrameType, 'children' | 'disable' | 'disabledStyle'>;
/**
 * フレームプロパティの必要項目を全て任意にした型
 */
export declare type DisabledFrameType = Partial<Omit<FrameType, 'children' | 'disable' | 'disabledStyle'>>;
