...
exports.ScrollViewFrame = void 0;
...
const Component = (props) => {
    ...
    return (<Frame {...styleProps} horizontal={horizontal}>
      {children}
    </Frame>);
};
const Frame = styled_1.styled.ScrollView `
...
`;
exports.ScrollViewFrame = react_1.default.memo(Component);
